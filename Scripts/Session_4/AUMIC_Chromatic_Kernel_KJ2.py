...
params['gp_amp0'] = radvel.Parameter(value= 216., vary=True)
params['gp_amplambda'] = radvel.Parameter(value=1.18, vary=True)
...
post.priors += [radvel.prior.Gaussian('gp_amp0',221., 10.)]# * [radvel.prior.Jeffreys('gp_amp0',1, 600)]
post.priors += [radvel.prior.HardBounds('gp_amplambda',0.3, 2.)]
